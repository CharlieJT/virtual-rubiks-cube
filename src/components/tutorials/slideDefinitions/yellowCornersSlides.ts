...
export function getYellowCornersSlides(): Slide[] {
  return [
    ...
    },
    {
      ...
      description:
        "Here we have an example where there are <b><i>0 corner pieces</i></b> that are correctly positioned. We need to get all 4 corner pieces into the correct positions.\n\nTo solve this, make sure you don't twist the top U layer as that will mess the edges up. Instead, physically turn the cube around to position correctly. Then perform the <b><i>'Niklas Algorithm'</i></b> <b><i>(U R U' L' U R' U' L)</i></b>. After this, you will find that the yellow/blue/red corner piece is in the correct corner. Put this one in the front right position and perform <b><i>'Niklas Algorithm'</i></b> <b><i>(U R U' L' U R' U' L)</i></b> again. After this, all corner pieces will be in their correct positions, though they may not be oriented correctly yet.\n\nThe corners pieces have been marked with either a <b><i>tick</i></b> or <b><i>cross</i></b> to indicate if they are correctly positioned or not.\n\nRepeat this several times until you're comfortable with the algorithm. You can use the <b><i>Reset</i></b> button to start the sequence over again if you get stuck or if you want to start over again.\n\nWhen you're ready to move on, click <b><i>Next</i></b> to move on to the next slide.",
      allowFaceMoves: true,
      setup: (cube: CubeJSWrapper) => {
        cube.reset();
        // Apply setup moves (logical notation)
    ...
    },
    {
      ...
      description:
        "Now the last example where there are <b><i>0 corner pieces</i></b> that are correctly positioned. We need to get all 4 corner pieces into the correct positions.\n\nTo solve this, perform the <b><i>'Niklas Algorithm'</i></b> <b><i>(U R U' L' U R' U' L)</i></b>. You will find that 1 corner piece is now correctly positioned. Put this correctly positioned piece in the front right position (by physically turning the cube, not twisting the top U layer), then perform <b><i>'Niklas Algorithm'</i></b> <b><i>(U R U' L' U R' U' L)</i></b> again. If it's still not solved, repeat the algorithm one more time with the correctly positioned piece in the front-right position, and all pieces will be in their correct positions, though they may not be oriented correctly yet.\n\nThe corners pieces have been marked with either a <b><i>tick</i></b> or <b><i>cross</i></b> to indicate if they are correctly positioned or not.\n\nRepeat this several times until you're comfortable with the algorithm. You can use the <b><i>Reset</i></b> button to start the sequence over again if you get stuck or if you want to start over again.\n\nWhen you're ready to move on, click <b><i>Next</i></b> to move on to the next slide.",
      allowFaceMoves: true,
      setup: (cube: CubeJSWrapper) => {
        cube.reset();
        // Apply setup moves (logical notation)
