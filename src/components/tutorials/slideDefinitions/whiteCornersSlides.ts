  ...
  return [
    {
      ...
      description:
        "Now that you have the White Cross completed, it's time to complete the white Face by positioning the <b><i>White Corner</i></b> pieces. Each corner pieces with a white sticker should be positioned on the face of the white center piece and match with its respective center piece.\n\nNotice how not only is the white face complete, the the first layer of the cube is complete as well. On each of the side face, it should look like a short <b><i>T</i></b> shape.\n\n<b>For this lesson, we only need to learn two algorithms to solve all white corners:</b>\n\n<b><i>Righty Algorithm:</i></b> R U R' U'\n<b><i>Lefty Algorithm:</i></b> L' U' L U\n\nThat's all you need! We'll see how these two algorithms can solve every white corner scenario. They should be easy to learn and remember. they are just two moves & then the same two in reverse to put the piece back in the correct position. For Example <b><i>R U</i></b> followed by <b><i>R' U'</i></b> will put the piece back in the correct position.\n\nTake the time to look at the cube to understand what we're aiming to achieve here then click <b><i>Next</i></b> to move on to the next slide.",
    ...
    },
    {
      ...
      description:
        "From this point forward, we'll take a more mechanical approach. Instead of intuitive problem-solving, we'll focus on recognizing specific scenarios and applying the correct algorithm to solve each piece.\n\nWe'll focus on learning how to insert the <b><i>White/Green/Red</i></b> into its correct position. As mentioned before, for white corners, we only need to learn two algorithms:\n\n<b><i>Righty Algorithm:</i></b> R U R' U'\n<b><i>Lefty Algorithm:</i></b> L' U' L U\n\nThat's all you need! We'll see how these two algorithms can solve every white corner scenario. Let's start with the first scenario in the <b><i>Next</i></b> slide.",
      allowFaceMoves: true,
      setup: (cube: CubeJSWrapper) => {
