...
export function getYellowEdgesSlides(): Slide[] {
  return [
    ...
    },
    {
      ...
      description:
        "The edge pieces here have been labelled with a <b><i>tick or cross</i></b> to indicate if a yellow edge piece is positioned against its center piece. In this example, we have 2 adjacent correctly positioned yellow edge pieces that are <b><i>ticked</i></b> and 2 that are <b><i>crossed</i></b>. For this, we position the correctly positioned yellow edge pieces <b><i>at the back and on the right hand side</i></b> and do the <b><i>Sune</i></b> algorithm (<b><i>R U R' U R U2 R'</i></b>), followed by a <b><i>U</i></b> move to correct them. Our goal is to have <b><i>4 of the edge pieces here</i></b> to be <b><i>ticked</i></b>.\n\nMake sure you try this several times until you're comfortable with the <b><i>Sune</i></b> algorithm. It's important to understand what's happening here. You can use the <b><i>Reset</i></b> button to start the sequence over again if you get stuck or if you want to start over again.\n\nWhen you're ready to move on, click <b><i>Next</i></b> to move on to the next slide.",
      allowFaceMoves: true,
      setup: (cube: CubeJSWrapper) => {
        cube.reset();
    ...
    },
    {
      ...
      description:
        "In this scenario, we have <b><i>2 correctly positioned edge pieces</i></b>, but they are <b><i>opposite from one another</i></b>. We hold them so that the correctly positioned edge pieces are <b><i>at the front and at the back</i></b>. We then do the <b><i>Sune</i></b> algorithm (<b><i>R U R' U R U2 R'</i></b>), which gives us 2 correct edges adjacent from one another. We then position these correctly positioned edge pieces in the <b><i>back and on the right</i></b> and do the <b><i>Sune</i></b> algorithm again (<b><i>R U R' U R U2 R'</i></b>), followed by a <b><i>U</i></b> move to align all the edges.\n\nMake sure you try this several times until you're comfortable with the <b><i>Sune</i></b> algorithm. It's important to understand what's happening here. You can use the <b><i>Reset</i></b> button to start the sequence over again if you get stuck or if you want to start over again.\n\nWhen you're ready to move on, click <b><i>Next</i></b> to move on to the next slide.",
      allowFaceMoves: true,
      setup: (cube: CubeJSWrapper) => {
        cube.reset();
    ...
    },
    {
      ...
      description:
        "Now we have <b><i>0 correctly positioned edge pieces</i></b>. We need to do a <b><i>U2 move</i></b> to get 2 edge pieces in position. After that, we position the correctly positioned edge pieces in the back and on the right. Then we perform the <b><i>Sune</i></b> algorithm (<b><i>R U R' U R U2 R'</i></b>), followed by a <b><i>U</i></b> move.\n\nMake sure you try this several times until you're comfortable with the <b><i>Sune</i></b> algorithm. It's important to understand what's happening here. You can use the <b><i>Reset</i></b> button to start the sequence over again if you get stuck or if you want to start over again.\n\nWhen you're ready to move on, click <b><i>Next</i></b> to move on to the next slide.",
      allowFaceMoves: true,
      setup: (cube: CubeJSWrapper) => {
        cube.reset();
