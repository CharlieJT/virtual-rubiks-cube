...
interface CompletionTickProps {
  /** Animation key to force re-render for animations */
  animKey?: number;
  /** Whether the circle progress animation should be complete */
  progress?: boolean;
  /** Whether the checkmark line animation should be complete */
  line?: boolean;
  /** Color of the tick (default: green) */
  color?: "green" | "red";
  /** Size class (default: w-6 h-6) */
  size?: "sm" | "md" | "lg";
}
