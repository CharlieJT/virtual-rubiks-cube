...
interface TutorialResetModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  isResetting?: boolean;
...
const TutorialResetModal: React.FC<TutorialResetModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  isResetting = false,
    ...
    <div className="space-y-4 text-gray-800 text-base">
      ...
      <div className="flex gap-3 justify-end">
        <Button
          ...
          className={`px-4 py-1 rounded-lg font-bold w-[110px] text-white border-none transition-opacity ${
            isResetting
...
export default TutorialResetModal;
