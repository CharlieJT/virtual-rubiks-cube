...
import SlideControls from "@components/tutorials/SlideControls";
import SpinTrackpad from "@components/UI/SpinTrackpad";
import FixBoxContent from "@components/tutorials/FixBoxContent";
import PracticeMovesPanel from "@components/tutorials/PracticeMovesPanel";
import {
...
import BeginnersMethodGrid from "../BeginnersMethodGrid";
import YellowCrossCasesGrid from "../YellowCrossCasesGrid";
import { useRubiksCube3DProps } from "@/hooks/useRubiksCube3DProps";
import { useTutorialPointerHandler } from "@/hooks/useTutorialPointerHandler";
import { useGhostPieceIndicator } from "@/hooks/useGhostPieceIndicator";
import GhostPieceIndicator from "@components/tutorials/GhostPieceIndicator";
...
interface TutorialCubeViewProps {
  ...
  lastMoveSourceRef: React.MutableRefObject<
