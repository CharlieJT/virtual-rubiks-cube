...
import { useSequenceMeasurements } from "@/hooks/useSequenceMeasurements";
import { useSequenceAnimations } from "@/hooks/useSequenceAnimations";
import {
  getPartState,
  getActiveColorInfo,
} from "@/utils/sequenceAnimationHelpers";
        ...
        {parts.map((part, partIdx) => {
          ...
          return (
            <SequencePartItem
              ...
              collapsingToPendingOpacityValue={collapsingToPendingOpacityValue}
              showTick={showTick}
