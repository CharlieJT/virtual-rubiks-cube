  ...
  return (
    <group position={position} renderOrder={10}>
      ...
      {faces.map((f) => {
        ...
        // Show logo on white center sticker when it's the face being animated (U/U' for top face)
        ...
        const showLogo =
          ...
          ((moveBase === "U" && f.key === "top") ||
            (moveBase === "D" && f.key === "bottom") ||
            (moveBase === "F" && f.key === "front") ||
            (moveBase === "B" && f.key === "back") ||
            (moveBase === "R" && f.key === "right") ||
            (moveBase === "L" && f.key === "left"));
